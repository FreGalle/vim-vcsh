...
" Experimental {{{
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-spellfile-local.git', {'depth': 0})
" }}}
" General {{{
...
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-big-file-options.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-cmdwin-ctrlc.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-cursorline-current.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-diff-prune.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-digraph-search.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-equalalways-resized.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-foldlevelstart-stdin.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-insert-cancel.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-insert-suspend-hlsearch.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-insert-timeout.git', {'depth': 0})
" call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-quickfix-auto-open.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-shebang-create-exec.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-strip-trailing-whitespace.git', {'depth': 0})
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-uncap-ex.git', {'depth': 0})
" }}}
...
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-make-target.git', {'depth': 0})
call minpac#add('neovimhaskell/haskell-vim')
call minpac#add('prisma/vim-prisma')
" 1}}}
" Programming {{{
...
call minpac#add('https://dev.sanctum.geek.nz/cgit/vim-juvenile.git', {'depth': 0})
